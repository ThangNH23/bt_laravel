...
class ShowProduct extends Component {
  ...
  previewEditImage() {
    const editShopOwner = $("#editShop_owner").val();
    $(document).ready(function (e) {
  ...
  async onSubmitHandle(e) {
    e.preventDefault();
    const newShopOwner = $("#inputShop_owner").val();
    ...
    await axios
      .post("http://localhost:8000/api/add-product", {
        ...
        shop_owner: $("#inputShop_owner").val(),
        
        shop_owner: $("#inputNew").val(),
      })
      .then((res) => {
        $("#inputImage").val("");
  ...
  async editProduct(id) {
    ...
    $("#editShop_owner").val(product.shop_owner);
  }
